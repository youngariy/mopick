...
import com.youngariy.mopick.adapters.MovieCastsOfPersonAdapter;
import com.youngariy.mopick.adapters.TVCastsOfPersonAdapter;
...
import com.youngariy.mopick.network.movies.MovieCastOfPerson;
    ...
    private void loadActivity() {
        ...
        mPersonDetailsCall.enqueue(new Callback<Person>() {
            ...
            public void onResponse(Call<Person> call, final Response<Person> response) {
                ...
                Glide.with(getApplicationContext()).asBitmap().load(Constants.IMAGE_LOADING_BASE_URL_1280 + response.body().getProfilePath())
                        .centerCrop()
